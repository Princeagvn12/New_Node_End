...
const getUsers = async (req, res, next) => {
  try {
    ...
    return createResponse(res, 200, 'Utilisateurs récupérés avec succès', { users });
  } catch (error) {
    next(error);
  }
};
...
const getUserById = async (req, res, next) => {
  try {
    ...
    return createResponse(res, 200, 'Utilisateur récupéré avec succès', { user });
  } catch (error) {
    next(error);
  }
};
...
const createUser = async (req, res, next) => {
  try {
    ...
    return createResponse(res, 201, 'Utilisateur créé avec succès', { user: userResponse });
  } catch (error) {
    next(error);
  }
};
...
const updateUser = async (req, res, next) => {
  try {
    ...
    return createResponse(res, 200, 'Utilisateur mis à jour avec succès', { user });
  } catch (error) {
    next(error);
  }
};
...
const toggleUserActive = async (req, res, next) => {
  try {
    ...
    return createResponse(res, 200, `Utilisateur ${status} avec succès`, { user });
  } catch (error) {
    next(error);
  }
};
